...
License:        CC0-1.0 AND (Unlicense OR MIT) AND MIT AND (Apache-2.0  OR  MIT) AND (CC0-1.0 OR MIT-0 OR Apache-2.0) AND GPL-2.0-only AND MPL-2.0 AND Zlib AND (0BSD OR MIT OR Apache-2.0) AND (Apache-2.0 OR MIT) AND (MIT OR Apache-2.0) AND (BSD-2-Clause OR Apache-2.0 OR MIT) AND (MIT OR Apache-2.0 OR CC0-1.0) AND (Zlib OR Apache-2.0 OR MIT) AND (MIT OR Zlib OR Apache-2.0) AND BSD-2-Clause AND (Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT) AND BSL-1.0 AND ISC AND (MIT OR Apache-2.0 OR Zlib) AND Unicode-3.0 AND (BSD-3-Clause OR MIT OR Apache-2.0) AND (Apache-2.0 OR BSL-1.0) AND BSD-3-Clause AND GPL-3.0-only AND Apache-2.0
