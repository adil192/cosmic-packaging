...
License:        (BSD-2-Clause OR Apache-2.0 OR MIT) AND GPL-2.0-only AND CC0-1.0 AND BSD-2-Clause AND (MIT OR Apache-2.0 OR CC0-1.0) AND (MIT OR Apache-2.0) AND (Apache-2.0 OR BSL-1.0) AND  AND Apache-2.0 AND (BSD-3-Clause OR MIT OR Apache-2.0) AND (MIT OR Apache-2.0 OR Zlib) AND MPL-2.0 AND Unicode-3.0 AND (0BSD OR MIT OR Apache-2.0) AND BSL-1.0 AND ISC AND (MIT OR Zlib OR Apache-2.0) AND (Apache-2.0 OR MIT) AND BSD-3-Clause AND (Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT) AND (CC0-1.0 OR MIT-0 OR Apache-2.0) AND (Apache-2.0  OR  MIT) AND MIT AND (Unlicense OR MIT) AND (Zlib OR Apache-2.0 OR MIT) AND GPL-3.0-only AND Zlib
